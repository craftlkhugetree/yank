  ...
  <div class="common-content">
    ...
    <div class="search-group">
      <span>
        ...
        >
          <el-option
            v-for="item in options.resNewStatus"
            :key="item.id"
            :label="item.name"
            :value="item.id"
          ></el-option>
    ...
    >
      ...
      <el-table-column prop="usestatus" label="状态" align="center">
        <template slot-scope="scope">
          <span :class="common.useStateColor(scope.row.useState)">{{
            common.useStateText(scope.row.useState)
          }}</span>
        </template>
      </el-table-column>
      <el-table-column
  ...
  methods: {
    ...
    download() {
      const data = {
        ...
        useState: this.searchForm.usestatus,
        eduTypeId: this.activeResType
      };
      let url = "/data/eduResUseDetailExport";
      let fileName =
