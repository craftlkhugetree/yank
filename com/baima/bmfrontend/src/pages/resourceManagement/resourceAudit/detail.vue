  ...
  <div style="background: #ffffff;" v-loading="loading">
    ...
    <div class="back-top" style="margin-bottom: 30px">
      ...
      <div
        ...
        @click="downHandover"
        v-if="auditDev === 'bm' && indexActiveName == 2"
      >
        <i class="el-icon-printer"></i>
        <span>下载进驻/退出交接单</span>
      </div>
      <div
        class="my-button green"
...
export default {
  ...
  methods: {
    ...
    downApply() {
      ...
      //   )
      // );
      this.common.outPutPdfFn(that, 'applyTable', 'normal-table', this.applyInfoForm.projectName + "申请表")
    },
    // 下载交接单
    downHandover() {
      this.handover = true;
      ...
      this.$nextTick(() =>
        that.common.transToPdf(
          this.applyInfoForm.projectName + "交接单",
          "handover",
          that
        )
      );
