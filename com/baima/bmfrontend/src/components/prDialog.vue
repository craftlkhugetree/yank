    ...
    <el-row>
      ...
      <el-col :span="16">
        ...
        >
          ...
          <!--<el-row :gutter="15">
            <el-col :span="12">
              <el-form-item :label-width="formLabelWidth" prop="prstarttime" style="margin-left: 0">
&lt;!&ndash;                <el-date-picker type="date" placeholder="开始日期" v-model="form.prstarttime" value-format="yyyyMMdd" style="width: 100%;" :picker-options="pickerOptions"></el-date-picker>&ndash;&gt;
              </el-form-item>
            </el-col>
            <el-col :span="12">
              <el-form-item :label-width="formLabelWidth" prop="prendtime" style="margin-left: 0">
                <el-date-picker type="date" placeholder="结束日期" v-model="form.prendtime" value-format="yyyyMMdd" style="width: 100%;" :picker-options="pickerOptions2"></el-date-picker>
              </el-form-item>
            </el-col>
          </el-row>-->
        </el-form-item>
  ...
  data() {
    return {
      ...
      rules: {
        ...
        /*  sleepstarttime: [{ required: true, message: '请选择住宿开始日期', trigger: 'blur' }],
          sleependtime: [{ required: true, message: '请选择住宿结束日期', trigger: 'change' }],*/
