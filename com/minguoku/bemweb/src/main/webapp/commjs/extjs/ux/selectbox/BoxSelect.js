...
Ext.ux.form.BoxSelect = Ext.extend(Ext.form.ComboBox, {
	separator : null,
	...
	initComponent:function() {
		...
		Ext.ux.form.BoxSelect.superclass.initComponent.call(this);
	},
	
	onRender:function(ct, position) {
		Ext.ux.form.BoxSelect.superclass.onRender.call(this, ct, position);
		...
		this.holder.on('click',this.onTriggerClick,this);
	...
	onResize : function(w, h, rw, rh){
		...
		Ext.ux.form.BoxSelect.superclass.onResize.call(this, w, h, rw, rh);
		this.autoSize();
	},
	...
	onKeyUp : function(e) {
		...
		Ext.ux.form.BoxSelect.superclass.onKeyUp.call(this, e);
	...
	onEnable: function(){
		Ext.ux.form.BoxSelect.superclass.onEnable.apply(this, arguments);
	...
	onDisable: function(){
		Ext.ux.form.BoxSelect.superclass.onDisable.apply(this, arguments);
		for(var k in this.boxElements){
			this.boxElements[k].disable();
		}
	},

    // 覆盖父类的这个方法，主要因为父类的这个方法会重新设置控件值，从而引起显示出错
    beforeBlur : function(){
	...
	getValue: function(){
		...
		return ret.join(this.separator || this.options['separator']);
	},
	...
	addItem: function(id, caption){
		var box = new Ext.ux.form.BoxSelect.Item({
			id: 'Box_' + id,
...
Ext.reg('boxselect', Ext.ux.form.BoxSelect);

Ext.ux.form.BoxSelect.Item = Ext.extend(Ext.Component, {

	initComponent : function(){
		Ext.ux.form.BoxSelect.Item.superclass.initComponent.call(this);
	},
	...
	onRender: function(ct, position){
		Ext.ux.form.BoxSelect.Item.superclass.onRender.call(this, ct, this.maininput);
