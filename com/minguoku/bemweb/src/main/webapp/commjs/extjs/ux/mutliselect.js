Ext.ux.MultiComBox = Ext.extend(Ext.form.ComboBox, {
    ...
    initList: function() {
        ...
        this.tpl = '<tpl for="."><div class="' + cls + '-item"><table border="0" width=80% height="16px" style="height:18px;"><tr ><td class="check-box" style="width:20px;height:18px;"></td><td style="font-size:12px;">{' + this.displayField + '}</td></tr></table></div></tpl>';
    ...
    onSelect: function(record, index, checked) {
        if (this.fireEvent('beforeselect', this, record, index) !== false) {
            ...
            this.select(index, false); // ÓÃÀ´Éè¶¨Ñ¡ÔñÑùÊ½
    ...
    setValue: function(v, checked) {
        ...
        for (i = 0, l = values.length; i < l; i++) {
            ...
            if (r) {
                var name = r.data[this.displayField],
                    value = r.data[this.valueField];
                var split = Ext.escapeRe(this.splitSign);
                var con = Ext.escapeRe(name.toString()),
                    val = Ext
...
/*
 * Ext.onReady(function() { var myData = [[3300, "ÅíÈÊÙç"], [3301, "ÀîÃ÷"], [3302,
 * "Íõ»ª"], [3303, "ÕÅÈý"], [3304, "ÀîËÄ"], [3305, "ÍõÎå"], [3306, "ÅíÐ¡Ã÷"], [3307, "ÕÅ»ª"],
 * [3308, "ÀîÐ¡"]];
 * 
 ...
 * 'local', emptyText : 'ÇëÑ¡Ôñ...', selectOnFocus : true, loadingText :
