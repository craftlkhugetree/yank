...
var CenterGrid= new Ext.grid.GridPanel({
    ...
    cm: new Ext.grid.ColumnModel([
        {header: '搜索关键字', dataIndex: 'NAME',width:120},
        {header: '出版社', dataIndex: 'LASTTIME',width:140},
        {header: 'PLATFORM', dataIndex: 'LASTTIME',width:140},
        {header: '用户名', dataIndex: 'NAME',width:120},
        {header: '总搜索量', dataIndex: 'NAME',width:120},
        {header: '2017-01', dataIndex: 'NAME',width:120},
        {header: '2017-02', dataIndex: 'NAME',width:120},
        {header: '2017-03', dataIndex: 'NAME',width:120}
    ]),
    viewConfig:{
        forceFit: true
    },
