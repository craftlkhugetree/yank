...
public class ExcelUtil {
			...
			for (int i = 1; i < realRows; i++) {
				...
				for (Entry<String, String> entry : fieldMap.entrySet()) {
					...
					if (sheet.getCell(col, i).getType() == CellType.DATE) {
						DateCell dateCell = (DateCell) sheet.getCell(col, i);
	...
	//从excel读取的日期可能出现为纯数字，这时候需要做一下转换
	public static String forMatExcelDaysToDate(int days,DateFormat df){
...
//		File file = new File("F:/cxlb_20171125_001/jslib_20170901_001_中华六法二民律上/docbook");
//		String filepath = file.getPath();
//		System.out.println(filepath);
//		String path = filepath.substring(filepath.indexOf("cxlb_20171125_001"), filepath.indexOf("docbook"));
//		path = path.replace("\\", "/");
//		System.out.println(path);
		...
		DateFormat df = new SimpleDateFormat("yyyy年MM月");
		System.out.println(forMatExcelDaysToDate(4384,df));
	}
