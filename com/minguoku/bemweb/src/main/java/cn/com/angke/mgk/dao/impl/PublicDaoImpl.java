...
@Service
public class PublicDaoImpl extends PlatformBaseDaoImpl implements PublicDao{
	
	public String TABLE_NAME = "WXK_PUBLISHING";

	public String SQL_SELECT = "select a.ID, a.NAME ,au.NAME as CREATER,a.CREATEDATE,aub.NAME as MODIFIER,a.MODIFYDATE "
			+ "from WXK_PUBLISHING a "
	...
	public String SQL_COUNT = "select count(a.ID) from WXK_PUBLISHING a \n";
