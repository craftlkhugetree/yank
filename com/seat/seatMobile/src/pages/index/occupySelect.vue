    ...
    <div class="selectOccupyTime">
      ...
      <ul>
        <li
          ...
          @click="selTime(v)"
        >
          {{ v.starttime.substring(0, 2) }}:{{ v.starttime.substring(2, 4) }}~{{
      ...
      this.util
        ...
        .then((res) => {
          if (res.success) {
            ...
            this.starttime = this.Opentime[0].starttime;
            this.endtime = this.Opentime[0].endtime;
            this.time.push(this.Opentime[0]);
            var obj = {
              starttime: this.Opentime[0].starttime,
              endtime: this.Opentime[0].endtime,
            };
