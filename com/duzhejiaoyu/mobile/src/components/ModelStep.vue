    ...
    <div class="step">
      <div
        ...
        :class="{
          ...
          active: index === curLearn.modelIndex,
        }"
      ...
      >
        ...
        <div
          class="step-item"
          v-else
          @click="canClick(index) ? changeModel(index) : void(0)"
          :class="{ last: index === list.length - 1 }"
        >
          <img
            v-if="item.isPass == '1'"
            class="tag"
            src="@/assets/img/learn-finish.png"
            alt
          />
        ...
        <img
          ...
          src="@/assets/img/learn-arrow-color.png"
          alt
        />
      </div>
    </div>
