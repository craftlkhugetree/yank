  ...
  <div class="login-form">
    ...
    <div class="edit-box">
      <el-form ref="editForm" :model="editForm" :show-message="false" label-position="top">
        <el-form-item label="证件号：" prop="loginname" required>
          <el-input
      ...
      <el-button v-if="newbornLogin && newbornLogin.val=='1'" class="link-btn" type="primary" plain round size="big" @click="$router.push('/newbornlogin')">
        本科新生登录
