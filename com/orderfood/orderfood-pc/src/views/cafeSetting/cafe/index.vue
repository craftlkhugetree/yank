        ...
        <div class="item-right order-type">
          ...
          <div v-if="order_type_selected == 1">
            ...
            <div class="item">
              ...
              >
                <i slot="suffix" style="line-height:32px;">分钟</i>
              </el-input>
              <span class="tips" v-if="!/^[1-9][0-9]*$/.test(setUpTime)">请输入正确的备餐时间！</span>-->
                    <el-input
                      v-model="setUpTime"
                      size="small"
                      placeholder="请输入备餐时间"
            ...
            <div class="item">
              ...
              <div class="item-right">
                ...
                <div v-else>
                  ...
                  <div class="add-btn" @click="addGoodsTime" v-if="!pickupGoodsList.length">+ 新增时间段</div>
                  <el-button type="primary" size="small" @click="savePickupTime">保存</el-button>
