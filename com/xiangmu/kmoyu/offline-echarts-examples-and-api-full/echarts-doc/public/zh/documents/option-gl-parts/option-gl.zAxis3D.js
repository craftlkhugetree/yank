window.__EC_DOC_option_gl_zAxis3D = {
  ...
  "nameTextStyle.color": {
    "desc": "<p>坐标轴名称的颜色，默认取 <a href=\"#zAxis3D.axisLine.lineStyle.color\">axisLine.lineStyle.color</a>。</p>\n"
  },
  ...
  "logBase": {
    "desc": "<p>对数轴的底数，只在对数轴中（<a href=\"#zAxis3D.type\">type</a>: &#39;log&#39;）有效。</p>\n"
  },
  "data": {
    "desc": "<p>类目数据，在类目轴（<a href=\"#zAxis3D.type\">type</a>: &#39;category&#39;）中有效。</p>\n<p>如果设置了 <a href=\"#zAxis3D.type\">type</a> 是 <code class=\"codespan\">&#39;category&#39;</code>，但没有设置 <code class=\"codespan\">axis.data</code>，则 <code class=\"codespan\">axis.data</code> 的内容会自动从 <a href=\"#series.data\">series.data</a> 中获取，这会比较方便。不过注意，<code class=\"codespan\">axis.data</code> 指明的是 <code class=\"codespan\">&#39;category&#39;</code> 轴的取值范围。如果不指定而是从 <a href=\"#series.data\">series.data</a> 中获取，那么只能获取到 <a href=\"#series.data\">series.data</a> 中出现的值。比如说，假如 <a href=\"#series.data\">series.data</a> 为空时，就什么也获取不到。</p>\n<p>示例：</p>\n<pre><code class=\"lang-js\">// 所有类目名称列表\ndata: [&#39;周一&#39;, &#39;周二&#39;, &#39;周三&#39;, &#39;周四&#39;, &#39;周五&#39;, &#39;周六&#39;, &#39;周日&#39;]\n// 每一项也可以是具体的配置项，此时取配置项中的 `value` 为类目名\ndata: [{\n    value: &#39;周一&#39;,\n    // 突出周一\n    textStyle: {\n        fontSize: 20,\n        color: &#39;red&#39;\n    }\n}, &#39;周二&#39;, &#39;周三&#39;, &#39;周四&#39;, &#39;周五&#39;, &#39;周六&#39;, &#39;周日&#39;]\n</code></pre>\n"
  },
  "data.value": {
    "desc": "<p>单个类目名称。</p>\n"
  },
