(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["base-upload"] = factory();
	else
		root["base-upload"] = factory();
...
"use strict";
/* harmony import */ var form_data__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__("9892");
...
/* harmony import */ var _env_classes_FormData_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__("4b6b");
...
// CONCATENATED MODULE: ./node_modules/cache-loader/dist/cjs.js?{"cacheDirectory":"node_modules/.cache/vue-loader","cacheIdentifier":"784b2526-vue-loader-template"}!./node_modules/vue-loader/lib/loaders/templateLoader.js??ref--5!./node_modules/cache-loader/dist/cjs.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./packages/test/src/BaseUpload.vue?vue&type=template&id=749c1a9b&
var render = function render(){var _vm=this,_c=_vm._self._c;return _c('input',{ref:"uploaddom",staticStyle:{"display":"none"},attrs:{"type":"file","rel":"files","multiple":_vm.multiple,"title":"上传文件"},on:{"change":_vm.getFile}})
}
var staticRenderFns = []


// CONCATENATED MODULE: ./packages/test/src/BaseUpload.vue?vue&type=template&id=749c1a9b&
...
// CONCATENATED MODULE: ./node_modules/cache-loader/dist/cjs.js??ref--12-0!./node_modules/thread-loader/dist/cjs.js!./node_modules/babel-loader/lib!./node_modules/cache-loader/dist/cjs.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./packages/test/src/BaseUpload.vue?vue&type=script&lang=js&
...
/* harmony default export */ var BaseUploadvue_type_script_lang_js_ = ({
  ...
  props: {
    ...
    failed_redirectToUrl: String,
    axiosSettings: Object,
    extraParams: Object,
    exts: String,
    size: [String, Number],
    multiple: {
  ...
  methods: {
    ...
    getFile(e) {
      ...
      if (this.axiosSettings && typeof this.axiosSettings === 'object') {
        for (let key in this.axiosSettings) {
          if (key !== 'url' && key !== 'data') {
            axiosSettings[key] = this.axiosSettings[key] || axiosSettings[key];
          }
        }
      }
      if (_this.genUploadPercent) {
        // onDownloadProgress 配置该属性代表允许为下载处理进度事件
        axiosSettings.onDownloadProgress = function (progressEvent) {
          //axios封装的原生获取下载进度的事件，该回调参数progressEvent中包含下载文件的总进度以及当前进度
          if (progressEvent.lengthComputable) {
            //属性lengthComputable主要表明总共需要完成的工作量和已经完成的工作是否可以被测量
            //如果lengthComputable为false，就获取不到progressEvent.total和progressEvent.loaded
            //实时获取最新下载进度
            _this.genUploadPercent(progressEvent.loaded / progressEvent.total * 100);
          }
        };
      }
      lib_axios(axiosSettings).then(data => {
        this.$refs.uploaddom.value = null;
        console.log('uploadData:', data);
        let res = data.data;
        if (res && (res.code === '000000' || res.success === true)) {
          this.done ? this.done(res) : this.$emit('done', res);
        } else {
          if (res && Object.prototype.hasOwnProperty.call(res, 'login') && !res.login) {
            let pathName = window.document.location.pathname;
            let projectName = pathName.substring(0, pathName.substr(1).indexOf('/') + 1);
            let url = projectName + '/';
            let purl = document.location.href; //
            location.href = this.failed_redirectToUrl ? this.failed_redirectToUrl : url + 'rest/Idsclient/reqLogin?reqUrl=' + encodeURIComponent(purl);
          } else {
            this.Toast(res.errInf.shortBusInf);
            this.done ? this.done(res) : this.$emit('done', res);
          }
        }
      });
...
// CONCATENATED MODULE: ./packages/test/src/BaseUpload.vue?vue&type=script&lang=js&
 /* harmony default export */ var src_BaseUploadvue_type_script_lang_js_ = (BaseUploadvue_type_script_lang_js_); 
...
// CONCATENATED MODULE: ./packages/test/src/BaseUpload.vue
...
var component = normalizeComponent(
  src_BaseUploadvue_type_script_lang_js_,
  render,
  staticRenderFns,
  false,
  null,
...
/* harmony default export */ var BaseUpload = (component.exports);
// CONCATENATED MODULE: ./packages/test/index.js
// 为组件提供 install 方法，供组件对外按需引入

BaseUpload.install = Vue => {
  Vue.component(BaseUpload.name, BaseUpload);
};
/* harmony default export */ var test = (BaseUpload);
...
//# sourceMappingURL=base-upload.umd.js.map