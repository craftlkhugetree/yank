<template>
  <div class="confirm">
    <van-nav-bar fixed title="年终奖确认" :border="false" left-arrow @click-left="$router.goBack()" />
...
<script>
import { fetchKpiDetail, doKpiConfirm } from "@/api/kpi/confirm";
...
export default {
  ...
  created() {
    let data = sessionStorage.getItem("yearConfirmDetail");
