  ...
  <div class="base-tab" ref="baseTab" v-loading="loading">
    <div class="base-search-table">
      <div class="header-box">
        ...
        <h3
          v-if="kpiData"
        >『 {{kpiData.groupname}} 』{{kpiData.yeardate}}年{{kpiData.monthdate}}月绩效清单审核</h3>
        <span>
        ...
        <div class="search-box-right">
          <div>
            <div style="margin-bottom: 10px;">
              <label>{{kpiData&&kpiData.yeardate}}年月度考核奖总额：</label>
      ...
      >
        ...
        <el-table-column
          ...
          :formatter="common.defaultFormat"
        ></el-table-column>
        <el-table-column prop="allowance" label="领导岗位津贴(元)" :formatter="common.defaultFormat"></el-table-column>
        <el-table-column prop="outsalary" label="外挂工资(元)" :formatter="common.defaultFormat"></el-table-column>
        <el-table-column prop="monthsalary" label="月度考核奖(元)" :formatter="common.defaultFormat"></el-table-column>
        <el-table-column prop="othersalary" label="其他(元)"></el-table-column>
        <el-table-column prop="totalsalary" label="月绩效合计(元)"></el-table-column>
...
import { findKpiById, reviewKpi, usedMonthFee } from "@/api/kpi/manage";
  ...
  computed: {
    ...
    alltotal() {
      ...
      this.tableData.forEach(row => {
        sum = this.common.add(sum, row.monthsalary, 2);
      });
      return sum;
    }
  },
      ...
      fetchQuotaList(param)
        .then(res => {
          if (res.success) {
            ...
            this.monthquota = quota.monthquota;
            this.getUsedFee(kpiItmes);
          }
        })
        .catch(err => {
          this.loading = false;
