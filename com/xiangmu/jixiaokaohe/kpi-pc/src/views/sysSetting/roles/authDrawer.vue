...
import { fetchUserList } from "@/api/admin/users";
export default {
  data() {
    return {
      title: "新增角色",
  ...
  computed: {
    // 是否可以设置用户 (角色考核工作组、分管领导不能设置)
    canSetUser() {
      if (["20210604-2", "20210604-3"].includes(this.editForm.id)) {
        return false;
      } else {
        return true;
      }
    ...
    getAuthList() {
      ...
      fetchRoleAuth(param).then(res => {
        ...
        this.authList.forEach((i, index) => {
          // 4个角色默认权限不可取消
          // 系统管理员20210604-5：系统配置菜单20210604-7
          if (this.editForm.id === "20210604-5" && i.ID === "20210604-7") {
            i.ISDEFAULT = true;
            i.items.forEach((j, index) => {
              j.ISDEFAULT = true;
            });
          }
          // 系统管理员20210604-5：绩效考核管理20210604-4
          if (this.editForm.id === "20210604-5" && i.ID === "20210604-4") {
            i.ISDEFAULT = true;
            i.items.forEach((j, index) => {
              if (
                [
          ...
          // 绩效发放人员20210604-4：绩效考核与奖励分配20210604-3
          if (this.editForm.id === "20210604-4" && i.ID === "20210604-3") {
            i.ISDEFAULT = true;
            i.items.forEach((j, index) => {
              if (
                [
          ...
          // 绩效发放人员20210604-4：绩效考核管理20210604-4
          if (this.editForm.id === "20210604-4" && i.ID === "20210604-4") {
            i.ISDEFAULT = true;
            i.items.forEach((j, index) => {
              if (
                [
          ...
          // 绩效发放人员20210604-4：绩效发放20210604-5，发放录入20210604-6
          if (this.editForm.id === "20210604-4" && (["20210604-5","20210604-6"].includes(i.ID))) {
            i.ISDEFAULT = true;
          }

          // 分管领导20210604-3：考核文件查看20210604-2
          if (this.editForm.id === "20210604-3" && i.ID === "20210604-2") {
            i.ISDEFAULT = true;
          }          
          // 分管领导20210604-3：绩效考核与奖励分配20210604-3
          if (this.editForm.id === "20210604-3" && i.ID === "20210604-3") {
            i.ISDEFAULT = true;
            i.items.forEach((j, index) => {
              if (
                [
          ...
          // 考核工作组20210604-2：考核文件查看20210604-2
          if (this.editForm.id === "20210604-2" && i.ID === "20210604-2") {
            i.ISDEFAULT = true;
          }
          // 考核工作组20210604-2：绩效考核与奖励分配20210604-3
          if (this.editForm.id === "20210604-2" && i.ID === "20210604-3") {
            i.ISDEFAULT = true;
            i.items.forEach((j, index) => {
              if (
                [
