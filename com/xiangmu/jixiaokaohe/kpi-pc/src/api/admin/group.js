...
// 该用户下的考核分组列表
export function fetchMyGroupList() {
    return service.postAjax({
        code: "url",
...
// 获取用户负责的考核组-分管领导
export function getUserLeaderGroups(data) {
    return service.postAjax({
        code: "url",
        url: "group/userLeaderGroups",
        data
    })
}

// 获取用户负责的考核组-考核工作组
export function getUserWorkGroups(data) {
    return service.postAjax({
        code: "url",
        url: "group/userWorkGroups",
        data
    })
}