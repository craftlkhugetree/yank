  ...
  <div>
    <div class="bindcontent">
      <div class="login-box">
        ...
        <p>
        <a class="pwd_modfiy" href="https://lib.cslg.edu.cn/bencandy.php?fid=227&aid=818" target="_blank">密码修改说明</a>
          ...
          .then(res => {
            ...
            if (res.success) {
              ...
              // } else {
                ...
                window.location.href =window.base.hwwxindex+"?authType=hwwx&param=" +params;
