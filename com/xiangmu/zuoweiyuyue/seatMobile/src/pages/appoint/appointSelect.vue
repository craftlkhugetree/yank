...
export default {
  ...
  computed: {
    isAppointedTime() {
      if (this.orderunit === 'week') {
        return window.base.isAppointedWeekTime;
      } else if (this.orderunit === 'day') {
        return window.base.isAppointedDayTime;
      }
    }
  },
  data() {
  ...
  methods: {
    ...
    getNextday() {
      ...
      var dmonth = "";
      var dday =
        day3.getDate() < 10 ? "0" + day3.getDate() : day3.getDate() + "";
      if (month < 10) {
        dmonth = "0" + month;
      } else {
        dmonth = month + "";
        ...
        .then(res => {
          if (res.success) {
            ...
            if (!this.isAppointedTime) {
              ...
              this.AppointResult(this.Opentime);
            } else {
              this.showtime = true;
            }
          }
