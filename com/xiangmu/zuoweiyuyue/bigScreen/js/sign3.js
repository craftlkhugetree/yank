$(function () {
  ...
  function createQrcode() {
    ...
    let content = {
      appid: '5fTnKzGLTWRYWFh9', // 这个学工统一提供
  ...
  function getParams() {
    ...
    IDSTGC = p.get('IDSTGC') || '2e49cd3edd0840ebb99099bff2909e5e';
    name = p.get('name');
    if (name) {
      document.getElementsByClassName('time3')[0].innerHTML = name;
    }
  }
  getParams();
  ...
  function getSectionDetail(data, text) {
    if (data && data.success === true) {
      ...
      let logo = document.getElementsByClassName('logo3')[0];
      let time = document.getElementsByClassName('time3')[0];
