...
* @Description: Utils - 日期/时间转换
*
* @version: v1.0.0
* @author: xyp
* @date: 2019年3月14日 上午9:56:30 
*/
public final class DateTimeUtil {
     ...
     * 把时间格式化成如：星期日，2004年十一月14号 格式的字符串
     */
    public final static String FMT_MMDDYY_CN2 = "yyyy年MM月dd日";
    ...
    /**
	 * 
	 * @Title: sysDateTimeStr   
	 * @Description: TODO(获取14位系统时间yyyyMMddHHmmss)   
	 * @param: @return      
	 * @return: String      
	 * @throws
	 */
	public static String sysDateTimeStr() {
