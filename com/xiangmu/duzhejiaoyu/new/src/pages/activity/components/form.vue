<template>
    <div>
        <div v-for="(v,i) in formitem" :key="i" class="labelbox">
            ...
            <span v-if="v.eltype==='radio'" class="radiobox">
                <el-radio v-for="e in v.children" :key="e" v-model="v.value" :label="e.value" readonly="v.disabled">{{e.value}}</el-radio>
            </span>
            <span v-if="v.eltype==='checkbox'" class="checkbox">
               <el-checkbox-group v-model="v.value">
                    <el-checkbox v-for="e in v.children" :key="e" name="type" :label="e.value" readonly="v.disabled">{{e.value}}</el-checkbox>
                </el-checkbox-group>
            </span>
            <span v-if="v.eltype==='select'" class="selectbox">
                <el-select v-model="v.value" placeholder="请选择" readonly="v.disabled">
                    <el-option
        ...
        <div style="margin-top:24px;" v-if="isapply==0">
