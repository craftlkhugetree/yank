...
<template>
    <div>
        ...
        <input type="file" rel="files" :accept="this.carmera" :multiple="multiple" @change="getFile" title="上传文件" ref="uploaddom" class="uploadinput">
    </div>
</template>
            ...
            getFile(e){
                ...
                let axiosSettings = {
                    ...
                    headers : {
                        ...
                        "IDSTGC": this.getCookie("IDSTGC") || "1a578c7de8f34289b40b93f89ce65f42",
