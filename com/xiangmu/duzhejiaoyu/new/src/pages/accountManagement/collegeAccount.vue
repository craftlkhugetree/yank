  ...
  <div>
    ...
    <div class="common-content" style="box-shadow:none;padding-bottom:50px">
      ...
      <el-table
        ...
        @sort-change="getSort"
      >
        <el-table-column prop="dept" label="学院" align="center" sortable show-overflow-tooltip></el-table-column>
...
export default {
  ...
  methods: {
    ...
    exportFile() {
      ...
      this.util
        .getUrlByCode(this.global.code, "/dataCollege/exportBottom" + str1)
        .then(res => {
