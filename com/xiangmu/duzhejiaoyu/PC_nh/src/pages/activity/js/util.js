...
console.log(code)
global.url['activity'] = code.baseURL;
...
let startAjax = function (options) {
  return new Promise(function (resolve, reject) {
    if (options && options.url && options.code) {
        let ajaxSettings = {
          url: global.url['activity']+options.url,
          method: 'POST',
          headers: {
            // "IDSTGC": getCookie("FRONT_IDSTGC") || "601e442d7a1945799e05cdf75264c9f3",
            "IDSTGC": getCookie("FRONT_IDSTGC")
          },
