    ...
    <div>
        <div v-for="(v,i) in formitem" :key="i" class="labelbox">
            ...
            <span v-if="v.eltype==='radio' && v.children" class="radiobox">
                <el-radio  v-for="e in v.children" :key="e.id" v-model="v.value" :label="e.value" readonly="v.disabled">{{e.value}}</el-radio>
            </span>
            <span v-if="v.eltype==='checkbox'" class="checkbox">
               <el-checkbox-group v-model="v.value" v-if="v.children"> 
                    <el-checkbox  v-for="e in v.children" :key="e.id" name="type" :label="e.value" readonly="v.disabled">{{e.value}}</el-checkbox>
                </el-checkbox-group>
            </span>
