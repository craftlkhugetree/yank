    ...
    state: {
        ...
        repairFlow: [{
            ...
            },
            {
                ...
                guideTitle: '检查IP地址',
                guideImg: ["@/../static/tw/tw-jcwl.png", "@/../static/tw/tw-jcip.png", "@/../static/tw/tw-jcip-2.png"]
            },
            {
            ...
            },
            {
                ...
                options: [{
                    ...
                    {
                        text: "userid error16或者Authentication Fail ErrCode=16--时间策略设置本时段不允许上网 ",
                        qid: 'success'
                    },
                    {
                        text: "其他情况，进入报修流程",
            ...
            },
            {
                ...
                guideTitle: '检查修改DNS',
                guideImg: ["@/../static/tw/tw-jcwl.png", "@/../static/tw/tw-jcip.png", "@/../static/tw/tw-jcdns.png", "@/../static/tw/tw-jcdns-2.png", "@/../static/tw/tw-jcdns-3.png", "@/../static/tw/tw-jcdns-4.png"]
            },
            {
                question: '检查网络？',
                id: '01',
            ...
            return new Promise((resolve, reject) => {
                util
                    ...
                    .then(res => {
                        ...
                        // 如果存在二级菜单, 将二级菜单缓存
                        let secondMenus = data.filter(i => i.children && i.children.length > 0);
