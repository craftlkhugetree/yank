  ...
  <div class="main">
    <el-row :gutter="60">
      ...
      <el-col :span="12">
        ...
        <div class="content">
          <edit-form ref="editComponent" :selfRepairFail.sync="selfRepairFail"></edit-form>
...
export default {
  ...
  created() {
    ...
    this.$nextTick(() => {
      let editCmp = this.$refs.editComponent
      editCmp.editForm.areaname = localStorage.getItem("areaname") || "";
      editCmp.editForm.roominfo = localStorage.getItem("roominfo") || "";
      editCmp.getGoodsTypeList();
    });
  }
};
</script>
