<template>
  <div class="main">
    ...
    <div class="content" v-loading="loading">
      <edit-form ref="editComponent" :showGuide="false"></edit-form>
      <div>
      ...
      this.util
        ...
        .then(res => {
          ...
          if (res.success) {
            ...
            let itemnames = data.itemname ? data.itemname.split("/") : [];
            data.goodstype = itemnames[0];
            data.goodsname = itemnames[1] || "";
            this.$refs.editComponent.editForm = data;
            this.$refs.editComponent.getGoodsTypeList();
          }
        })
        .catch(err => {
          this.loading = false;
