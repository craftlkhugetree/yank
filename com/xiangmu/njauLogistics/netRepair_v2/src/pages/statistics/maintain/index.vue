<template>
  <div class="statistic-box">
    ...
    <div class="count-box" v-loading="workerLoading">
      <div class="count-box-title">
        <span>各维修工维修工作量对比</span>
...
export default {
  ...
  methods: {
    // 导出数据
    exportWorkerData() {
      let url = `${window.g.url}dataRepair/exportDeptOneBottom`;
