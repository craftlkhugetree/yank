  ...
  <el-timeline>
    ...
    >
      <div class="process-box">
        ...
        <span class="time" v-if="item.creatername">处理人：{{item.creatername}}{{item.type == '5' ? '' : ' (' + item.createrid + ')'}}</span>
        ...
        <p v-if="item.type === '1'">
          {{item.creatername}}办理给维修责任人
          <strong>【{{item.repairleadername}}】</strong>
        </p>
