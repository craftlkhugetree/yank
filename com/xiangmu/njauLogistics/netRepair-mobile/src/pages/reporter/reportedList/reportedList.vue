  ...
  <div>
    ...
    <div class="orderlists">
      <div class="tabs clearfix">
        <div class="tabitem" :class="{ active: tabs === '1' }" @click="changeTab('1')">
          <p class="tablabel">
            待办理
            <span>{{num1}}</span>
          </p>
      ...
      <div class="lists">
        ...
        <div class="status1list" v-if="tabs === '3'">
          ...
          >
            ...
            <emptyList class="emptylist animation-1" v-show="!status3List.length"></emptyList>
          </van-list>
        </div>
      </div>
      <!---------------------------- 底部按钮 ---------------------------->
      <div class="footer" v-if="isBatch && tabs == '1'">
        ...
        <div class="right-btn">
          ...
          <van-button class="search-btn" round type="info" plain @click="handleBatch('move')">批量转移</van-button>
        </div>
      </div>
    </div>
    <!-- 接报修人员选择维修负责人弹窗 -->
