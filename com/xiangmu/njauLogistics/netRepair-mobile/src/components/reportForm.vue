    ...
    >
      ...
      <div class="selecters">
        <span
          ...
          :key="item.id"
          @click="
            reportForm.faulttype = item.id;
            reportForm.areatype =
              reportForm.faulttype != '1' && reportForm.areatype == '6'
                ? '1'
                : reportForm.areatype;
          "
          >{{ item.name }}</span
      ...
      <div class="selectforms">
        ...
        <div class="forms forms1" v-show="reportForm.areatype === '1'">
          ...
          <van-field
            ...
            :rules="[
              {
                required: reportForm.areatype === '1' && !areaForm1.pubareainfo,
                message: '填写房间号由物业中心维修'
              }
            ]"
          />
          <span>或</span>
        ...
        <!--------------------------- 浦口的表单 --------------------------->
        <div class="forms forms4" v-show="reportForm.areatype === '7'">
          <van-field
            :rules="[
              {
                required: reportForm.areatype === '7',
                message: '请输入浦口学生公寓名称'
              }
            ]"
            v-model="areaForm7.areaname"
            placeholder="请输入浦口学生公寓名称"
            class="fieldbottom deptname"
          />
        </div>
        <!--------------------------- 学校其他楼宇的表单 --------------------------->
