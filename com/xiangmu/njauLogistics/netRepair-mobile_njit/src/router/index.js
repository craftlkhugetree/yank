...
import Continue from "@/pages/userOrders/continue";
...
import handleDistributeBatch from "@/pages/distributer/handleDistributeBatch";
import callbackDistribute from "@/pages/distributer/callback/callbackDistribute";
import callbackDistributeBatch from "@/pages/distributer/callbackBatch";
...
export default new Router({
  ...
  routes: [
    ...
    },
    {
      ...
      path: "/handleDistribute/:id/:version",
      name: "handleDistribute",
      component: handleDistribute,
    },
    {
      //维修负责人--批量处理单子（派单重复保修暂不维修已维修
      path: "/handleDistributeBatch",
      name: "handleDistributeBatch",
      component: handleDistributeBatch,
    },
    {
      //维修负责人--退回单子
      path: "/callbackDistribute/:id/:version",
      name: "callbackDistribute",
      component: callbackDistribute,
    },
    {
      //维修负责人--批量退回单子
      path: "/callbackDistributeBatch",
      name: "callbackDistributeBatch",
      component: callbackDistributeBatch,
    },
    {
      //维修负责人--派单后重新办理
