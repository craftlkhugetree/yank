  ...
  <div class="list-box">
    ...
    <div class="list-box-content clearfix">
      <div class="left-content">
        ...
        <span class="status-tag" v-if="activeTab=='1'">
          <i class="iconfont iconshijianzhongbiao2"></i>
          维修时间：{{common.timeFormat(item.starttime,"YYYY-MM-DD")}}
        </span>
        <span class="status-tag" v-if="activeTab=='2'">{{common.statusRepFormat(item.status)}}</span>
      </div>
