<template>
  <div style="min-height:800px;">
    ...
    <el-row>
      <!------------------------- 待办理/已办理列表 ------------------------->
      <el-col :span="12">
        <list @getTotal="getTotal" ref="list" :params="listParams" canDown></list>
      ...
      <!------------------------- 待办理/已办理详情 ------------------------->
      <el-col :span="12">
        <detail ref="detail" v-if="curItem.id" :id="curItem.id" canDown v-loading="loading"></detail>
      </el-col>
    </el-row>
  </div>
</template>
