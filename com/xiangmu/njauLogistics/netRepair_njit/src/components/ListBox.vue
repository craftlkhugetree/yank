      ...
      <div v-if="showDetail">
        <div class="list-box-content" style="margin-bottom:0">
          ...
          <div class="process" v-if="operType ==='edit' && detail.applystatus === '4'">
            ...
            <div class="process-content">
              <score-form ref="scoreComponent" :id="detail.id" :version="detail.version" @doFunc="getDetail"></score-form>
            </div>
          </div>
        </div>
        ...
        <div class="list-box-footer">
          ...
          <div class="right-btns">
            <el-button
              v-if="detail.applystatus < '4' && operType ==='edit'"
              type="primary"
              size="small"
              @click="toContinue"
            >我要续报</el-button>
...
export default {
  ...
  methods: {
    ...
    // 续报
    toContinue() {
      this.$router.push(`/continue/${this.item.id}`);
    },
    // 获取维修单信息
