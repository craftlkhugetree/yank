  ...
  <div class="list-box">
    ...
    <div class="list-box-content clearfix">
      <div class="left-content">
        ...
        <el-button v-if="item.applystatus >= '5' && canDown" class="down-btn" type="primary" size="small" icon="el-icon-download" @click="downloadApply">下载</el-button>
      </div>
...
export default {
  ...
  methods: {
    // 下载报修单
    downloadApply() {
      let url = `${window.g.url}apply/downloadPdf?applyid=${this.item.id}`;
