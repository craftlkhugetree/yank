      ...
      this.util
        ...
        .then(res => {
          ...
          this.authList.forEach((i, index) => {
            ...
            if (this.roleId === "9100002-2" && i.ID === "9100002-2") {
              i.ISDEFAULT = true;
            ...
            if (this.roleId === "9100002-3" && i.ID === "9100002-2") {
              i.ISDEFAULT = true;
              i.items.forEach((j, index) => {
            ...
            if (this.roleId === "9100002-4" && i.ID === "9100002-8") {
              i.ISDEFAULT = true;
              i.items.forEach((j, index) => {
            ...
            // 全校师生 默认菜单 首页
            if (this.roleId === "9100002-1" && i.RESID === "9100002-1") {
              i.ISDEFAULT = true;
            }
