  ...
  <div style="min-height:800px;">
    ...
    <transition class="container" name="slide-fade">
      <el-row v-if="activeTab==='1'">
        <el-col :span="12">
          <list key="1" ref="list" v-if="userId" :params="listParams" :activeTab="activeTab"></list>
        </el-col>
        <!------------------------- 待维修详情 ------------------------->
        <el-col :span="12">
          <repair-detail ref="detail" v-if="curItem.id" :id="curItem.id" v-loading="loading">
    ...
    <transition class="container" name="slide-fade1">
      <el-row v-if="activeTab==='2'">
        <el-col :span="12">
          <list key="2" ref="list" v-if="userId" :params="listParams" :activeTab="activeTab"></list>
        </el-col>
        <!------------------------- 已维修详情 ------------------------->
        <el-col :span="12">
          <detail ref="detail" v-if="curApplyItem.id" :id="curApplyItem.id" v-loading="loading"></detail>
        </el-col>
      </el-row>
    </transition>
  </div>
  ...
  computed: {
    ...
    listParams() {
      return {
        ...
        status: this.activeTab === "1" ? "1" : "2,3,4",
