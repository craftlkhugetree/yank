<template>
  <div class="bgc">
    ...
    <h1>欢迎来到网上报修系统</h1>
    <div class="routers color1" @click="go('/start')">
    ...
    <div
      ...
      v-if="userType.indexOf('9100002njit-2') != -1"
    >
    ...
    <div
      ...
      v-if="userType.indexOf('9100002njit-3') != -1"
    >
      <img src="../../../static/images/reporter.png" alt />
    ...
    <div
      ...
      v-if="userType.indexOf('9100002njit-4') != -1"
    >
    ...
    this.util
      ...
      .then(res => {
        ...
        for (let k = 0; k < res.data.length; k++) {
          if (res.data[k].GROUPID === "9100002njit") {
