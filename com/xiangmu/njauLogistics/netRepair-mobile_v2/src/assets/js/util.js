...
global.url['ids'] = window.g.idsUrl;

var IDSTGC = "d095a1d2006f44f68c1dca16b891ac56";
            ...
            if (options && options.url && options.code) {
                getRealUrl(options.code, options.url).then(function(data) {
                    ...
                    let ajaxSettings = {
                        ...
                        // console.group(options.isRep ? 'requestBody' : 'formData');
                        // console.group(ajaxSettings.data);
                        // console.groupEnd();
                        // console.groupEnd();
                        // resolve();
                        // return;
