...
<script>
import { getUserMenu, getUserInfo } from '@/api/roles';
export default {
  data() {
    return {
      loading: false,
        ...
        .then(res => {
          ...
          if (menuFlag) {
            ...
            this.menuData.unshift({
              ...
              ICONCLS: 'message-icon',
              PID: '16000-033',
              DISPLAYURL: '/sys-manage/user-center',
              ID: '16000-g3334',
              text: 'ld统计',
              leaf: true,
              iconCls: 'message-icon',
            ...
            this.menuData.unshift({
              ...
              ICONCLS: 'message-icon',
              PID: '16000-033',
              DISPLAYURL: '/tc/famous',
              ID: '16031231120-g35334',
              text: 'ld统计',
              leaf: true,
              iconCls: 'message-icon',
              URL: '',
            ...
            this.menuData.unshift({
              ...
              ICONCLS: 'message-icon',
              PID: '16000-033',
              DISPLAYURL: '/tc/specialSponser',
              ID: '312160aaa3120-g35334',
              text: 'ld统计',
              leaf: true,
              iconCls: 'message-icon',
              URL: '',
            ...
            this.menuData.unshift({
              ...
              ICONCLS: 'message-icon',
              PID: '16000-033',
              DISPLAYURL: '/tc/alumnaSponser',
              ID: '312160534aaa3120-g35334',
              text: 'ld统计',
              leaf: true,
              iconCls: 'message-icon',
              URL: '',
