<template>
  <div class="bgc">
    ...
    <div class="figuertotal">
      ...
      <div class="figuers">
        ...
        <div class="figuernum figuernum1">
          {{ formatNum(avatime) }}
        <!-- <countTo class="counttospan figuernum" :startVal='0' :endVal='formatNum(avatime)' :duration='1000'></countTo> -->

        </div>
      </div>
    </div>
    <el-table :data="tableData1.body" style="width: 100%" class="toptable">
      <el-table-column
    ...
    <div class="figuerchart">
      <p class="tabletitle">回复时长对比(天)</p>
      <div class="chart" ref="chart"></div>
      <p class="tabletitle">回复时长对比详细</p>
      <div class="datatable">
...
export default {
  ...
  methods: {
    ...
    exportData() {
      ...
      window.open(
        window.g.url + "/dataReply/exportReplyBottom?" + str.join("&")
      );
    },
    formatNum(num) {
    ...
    getNums() {
      ...
      this.util
        ...
        .then((res) => {
          ...
          //整理表格所需要的数据
          this.tableData1.header = ["统计种类", ...res.data.header];
          let tableDataArr = [];
          _.forEach(res.data.body, (body, index) => {
            let dataObj = {
              统计种类: indextype[index],
            };
