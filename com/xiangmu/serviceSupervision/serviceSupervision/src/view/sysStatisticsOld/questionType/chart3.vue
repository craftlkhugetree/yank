<template>
  <div>
    ...
    <p class="title title2">
      各业务领域提问类型对比<span class="changebar">
    ...
    <div class="wbgc">
      <el-tabs v-model="activeType" @tab-click="clicktab">
        <el-tab-pane label="咨询量" name="1"></el-tab-pane>
        <el-tab-pane label="表扬量" name="2"></el-tab-pane>
        <el-tab-pane label="投诉量" name="3"></el-tab-pane>
        <el-tab-pane label="反馈量" name="4"></el-tab-pane>
        <el-tab-pane label="其他量" name="5"></el-tab-pane>
      </el-tabs>
      <p class="tabletitle">提问类型对比</p>
      <div class="chart" ref="chart"></div>
      <p class="tabletitle">提问类型对比详细</p>
      <div class="datatable">
...
export default {
  ...
  methods: {
    ...
    exportData() {
      ...
      window.open(
        window.g.url + "/dataType/exportTypeDeptBottom?" + str.join("&")
      );
    },
    clicktab() {
      this.getData(this.selectValue);
