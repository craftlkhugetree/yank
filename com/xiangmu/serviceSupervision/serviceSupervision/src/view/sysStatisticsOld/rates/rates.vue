    ...
    <div class="figuertotal">
      <div class="figuers">
        ...
        <div class="figuernum">
          ...
          <countTo class="counttospan figuernum" :startVal='0' :endVal='Number(formatNum(numdata.total1))' :duration='1000'></countTo>
      ...
      <div class="figuers">
        ...
        <div class="figuernum">
          ...
          <countTo class="counttospan figuernum" :startVal='0' :endVal='Number(formatNum(numdata.all1))' :duration='1000'></countTo>
      ...
      <div class="figuers">
        ...
        <div class="figuernum">
          ...
          <countTo class="counttospan figuernum" :startVal='0' :endVal='Number(formatNum(numdata.all2))' :duration='1000'></countTo>
      ...
      <div class="figuers">
        ...
        <div class="figuernum">
          ...
          <countTo class="counttospan figuernum" :startVal='0' :endVal='Number(formatNum(numdata.all3))' :duration='1000'></countTo>
      ...
      <div class="figuers">
        ...
        <div class="figuernum">
          ...
          <countTo class="counttospan figuernum" :startVal='0' :endVal='Number(formatNum(numdata.all4))' :duration='1000'></countTo>
      ...
      <div class="figuers">
        ...
        <div class="figuernum">
          ...
          <countTo class="counttospan figuernum" :startVal='0' :endVal='Number(formatNum(numdata.all5))' :duration='1000'></countTo>
...
export default {
  ...
  mounted() {
    ...
    // this.getData2(this.selectValue2);
  },
  methods: {
    changeTimeType() {
      this.selectValue1 = new Date();
