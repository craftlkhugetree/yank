        ...
        <el-col :span="11" class="base-search-table">
          ...
          <div class="table-content">
            ...
            >
              ...
              <!-- <el-table-column prop="USERTYPE" sortable="custom" label="用户类型" width="100"></el-table-column> -->
            </el-table>
          </div>
          <!---------------------------- 分页 ---------------------------->
          <div class="pagination-box" v-if="totalA > 0">
            <el-pagination
              ...
              @size-change="size => getUserList(currentPageA, size)"
            ></el-pagination>
          </div>
        </el-col>
