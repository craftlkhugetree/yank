  ...
  <div class="main-div" ref="mainDiv">
    ...
    <div class="right-div base-search-table">
      <div class="search-box clearfix">
        ...
        <!---------------------------- 查询条件 ---------------------------->
        <div class="search-box-right">
          <el-input class="input-box" style="width:180px;" v-model="keyword" placeholder="请输入名称" size="small" clearable></el-input>
          <el-button
            type="primary"
            size="small"
            icon="el-icon-search"
      ...
      <div class="table-content">
        ...
        >
          ...
          <el-table-column prop="ORGNAME" sortable="custom" label="部门" :formatter="common.defaultFormat"></el-table-column>
