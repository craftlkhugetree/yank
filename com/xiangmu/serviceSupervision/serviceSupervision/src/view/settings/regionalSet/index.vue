  ...
  <div class="base-search-table">
    <div class="search-box clearfix">
      ...
      <div class="search-box-right">
        <el-input class="input-box" v-model="keyword" placeholder="请输入区域" size="small" clearable></el-input>
        <el-button
          type="primary"
          size="small"
          icon="el-icon-search"
      ...
      >
        ...
        <el-table-column label="操作" align="center" width="190">
          <template slot-scope="scope">
            <div class="more-span">
              <span @click="editRegion(scope.row)">编辑</span>
              <span @click="deleteRegion(scope.row)">删除</span>
            </div>
          </template>
        </el-table-column>
      </el-table>
    ...
    >
      ...
      <span slot="footer">
        <el-button type="primary" size="small" @click="saveRegion">提交</el-button>
