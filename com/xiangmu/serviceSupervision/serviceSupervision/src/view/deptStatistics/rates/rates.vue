...
export default {
  ...
  methods: {
    ...
    exportDeptData() {
      ...
      let query = `?starttime=${starttime}&endtime=${endtime}&handledeptid=${this.activeTab}`;
      window.open(url + query, "_blank");
    },
    // 初始化图表
    initCharts() {
