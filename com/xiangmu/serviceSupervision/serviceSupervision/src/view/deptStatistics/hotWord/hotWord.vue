<template>
  <div>
    <el-tabs v-model="activeDept" @tab-click="clickTab" class="card-tabs" type="border-card">
      <el-tab-pane v-for="item in userDeptList" :key="item.ID" :label="item.NAME" :name="item.ID"></el-tab-pane>
    </el-tabs>
    <div class="bgc">
      ...
      <div class="toplist clearfix">
        <div class="leftlist">
          ...
          <p class="indexitem" v-for="(item, index) in topList" :key="index">
