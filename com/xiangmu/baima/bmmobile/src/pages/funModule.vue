<template>
  <div class="choose-role">
    ...
    <div class="tab-bar" :style="tabmenu.length == 1 ? { 'justify-content': 'space-evenly' } : ''">
      <div
        class="bd1"
  ...
  methods: {
    ...
    initTabMenu() {
      if (this.curRole === '16000-5') {
        ...
        // 后勤
        this.tabmenu = [
          { icon: 'icon-bmg-practice', text: '本科生实习', path: '/practice-audit-hq' },
          { icon: 'zxbx', text: '在线报修', path: '/repair-hq' },
        ];
      }
      // 如果是刚进入系统，则跳转到第一个菜单
