  ...
  <div>
    ...
    <div class="form-box">
      ...
      <div class="form-box-content">
        ...
        <van-cell
          v-if="detail.teachers && detail.teachers.length === 0"
          title="参与教师"
          value="--"
        ></van-cell>
      ...
      this.util
        ...
        .then(res => {
          if (res.success) {
            ...
            let isSameDay = this.detail.eatstarttime === this.detail.eatendtime;
            let eatObj = {
              '1,1': '含早餐',
              '2,2': '含中餐',
              '3,3': '含晚餐',
            ...
            if (isSameDay) {
              ...
              this.detail.eatstarttype = this.detail.eatendtype = eatObj[str];
            } else {
            if (eatstarttype) {
              switch (eatstarttype) {
                case '1':
            ...
            //进程日期 1申请 3单位领导 4基地 5水电工
            let process = res.item.events.filter(i => ['1', '3', '4', '5'].includes(i.eventtype));
            process.forEach(i => {
              ...
              switch (i.eventtype) {
                ...
                case '5':
                  ...
                  this.processData[3].status = i.eventresult == 1 ? 'success' : 'fail';
                  break;
                default:
                  break;
              }
