  ...
  <div>
    ...
    >
      ...
      <el-table-column
        ...
        key="mianji"
      ></el-table-column>
      <el-table-column prop="createTime" label="申请时间" align="center" width="200" key="sqsj">
      ...
      >
        <template slot-scope="scope">
          <span :style="{ color: scope.row.priceNum || scope.row.priceNum == 0 ? 'red' : '' }">
            {{ scope.row.priceNum || scope.row.priceNum == 0 ? scope.row.priceNum : '--' }}
          </span>
        </template>
      </el-table-column>
      <el-table-column
      ...
      >
        <template slot-scope="scope">
          {{
            (scope.row.payTime && common.formatTime(scope.row.payTime, 'yyyy-MM-dd HH:mm:ss')) ||
              '--'
          }}
        </template>
      </el-table-column>
