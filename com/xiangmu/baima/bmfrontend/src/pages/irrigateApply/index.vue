<template>
  <div class="common-content">
    ...
    <el-dialog
      ...
      :title="dialogType == 'add' ? '资源申请新增' : '资源申请编辑'"
...
export default {
  ...
  data() {
    return {
      ...
      firstRow: {},
      showViewer: false,
      srcList: [require("st@tic/images/help-ggys.png")]
    };
  },
  ...
  methods: {
        ...
        .then(res => {
          if (res.success == true) {
            ...
            this.form = {
              ...
              irdate:
                type == "edit" ? apply.irdate : this.util.formatMYD(new Date()),
              note: apply.note,
    ...
    submitData(type) {
      ...
      if (!form2.applyerid) {
        form2.applyerid = this.$store.state.userInfo.ID;
      }
      //资源编号格式转换
      let arr = [];
