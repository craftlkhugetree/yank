    ...
    >
      ...
      >
        <template slot-scope="scope">
          <span :class="common.statusColorPractice('', '', scope.row.applystatus)">{{
  ...
  methods: {
    ...
    download() {
      let params = JSON.stringify({
        ...
        orgid: this.isLeader ? this.$store.state.userInfo.ORGID : this.searchForm.orgid
      });
      console.log(params);
      this.util
        .getUrlByCode(this.global.code, "/data/exportPrapply")
        .then(res => {
