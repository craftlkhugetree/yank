      ...
      <div class="item">
        ...
        <el-row class="content">
          <el-col :span="20">
            ...
            水资源申请时间限制：最少提前
            <el-input-number
              v-if="!IRAPPLYDAY.isEdit"
              v-model="IRAPPLYDAY.rulevalue"
              size="small"
            ...
            <el-time-picker
              v-if="!IRAPPLYTIME.isEdit"
              v-model="IRAPPLYTIME.rulevalue"
            ...
            ></el-time-picker>
            <span v-else>{{
              common.add_comma_toThousands(IRAPPLYTIME.rulevalue)
            }}</span>
            ，最多提前
            <el-input-number
              v-if="!IRAPPLYDAY.isEdit"
              v-model="MOSTDAY.rulevalue"
              size="small"
              controls-position="right"
              style="width: 100px"
              :min="0"
              ...
              placeholder="请输入内容"
            ></el-input-number>
            <span v-else>（{{ MOSTDAY.rulevalue }}）</span> 天申请。
          </el-col>
          <el-col class="operate" :span="4" style="text-align: right">
            <div
              v-if="IRAPPLYDAY.isEdit"
              @click="edit('IRAPPLYDAY')"
              class="end-btn"
            >
              <img
                src="../../../../static/images/bm-rule-edit.png"
                alt=""
              />编辑
            </div>
            <div v-else @click="save('IRAPPLYDAY')" class="end-btn">
              <img
                src="../../../../static/images/bm-rule-save.png"
                alt=""
              />保存
            </div>
          </el-col>
      ...
      <div class="item">
        ...
        <el-row class="content">
          <el-col :span="20">
            资源最多可选择数：
            <el-input-number
              v-if="!SPAPPLYNUM.isEdit"
              v-model="SPAPPLYNUM.rulevalue"
              size="small"
              controls-position="right"
              style="width: 100px"
              placeholder="请输入内容"
      ...
      <div class="item">
        ...
        <el-row class="content">
          <el-col :span="20">
            教职工需提前
            <el-input-number
              v-if="!PRJZGDAY.isEdit"
              v-model="PRJZGDAY.rulevalue"
              size="small"
              controls-position="right"
              style="width: 100px"
              placeholder="请输入内容"
              ...
              :precision="0"
            ></el-input-number>
            <span v-else>（{{ PRJZGDAY.rulevalue }}）</span>
            天申请，领导审批提前
            <el-input-number
              v-if="!PRLDDYA.isEdit"
              v-model="PRLDDYA.rulevalue"
              size="small"
              controls-position="right"
              style="width: 100px"
              placeholder="请输入内容"
              ...
              :precision="0"
            ></el-input-number>
            <span v-else>（{{ PRLDDYA.rulevalue }}）</span
            >天前可审批，超过该天数，系统自动设为审批不通过，原因超时
          </el-col>
          <el-col class="operate" :span="4" style="text-align: right">
            <div
              v-if="PRJZGDAY.isEdit"
        ...
        <el-row class="content">
          <el-col :span="18">
            <img
              ...
              src="../../../../static/images/bm-filetype-common.png"
              alt=""
            />
            <div style="display: inline-block;vertical-align: top">
              <div>
                {{
                  BILLTEMPLATE && BILLTEMPLATE.TITLE ? BILLTEMPLATE.TITLE : ""
                }}
              </div>
            </div>
          </el-col>
          ...
          >
            <span
              style="margin-right: 15px;color: #00B09B;cursor: pointer;"
              @click="common.previewFile(BILLTEMPLATE.ID)"
              class="end-btn"
            >
              <img
                style="width: 19px;height: 20px;margin-right: 10px"
                src="../../../../static/images/bm-file-preview.png"
                alt=""
              />预览
            </span>
            <span>
              <a
                :href="downUrl + BILLTEMPLATE.ID"
                target="_blank"
                style="text-decoration: none;color: #00B09B"
                class="end-btn"
              >
                <img
                  style="width: 21px;height: 19px;margin-right: 1px"
                  src="../../../../static/images/bm-rule-file-down.png"
                  alt=""
                />
                <span>下载</span>
              </a>
    ...
    save(type) {
      ...
      switch (type) {
        case "IRAPPLYDAY":
          let arr = [];
          arr.push({
            id: this.IRAPPLYDAY.id,
            rulevalue: this.IRAPPLYDAY.rulevalue || 0
          });
          arr.push({
            id: this.IRAPPLYTIME.id,
            rulevalue: this.IRAPPLYTIME.rulevalue
          });
          arr.push({
            id: this.MOSTDAY.id,
            rulevalue: this.MOSTDAY.rulevalue || 0
          });
          // console.log(arr);
        ...
        case "PRJZGDAY":
          ...
          arr2.push({
            id: this.PRJZGDAY.id,
            rulevalue: this.PRJZGDAY.rulevalue
          });
          ...
          if (res.success == true) {
            ...
            this.rulesList.forEach(v => {
              ...
              switch (v.rulecode) {
                case "IRAPPLYDAYMAX":
                  this.MOSTDAY = v;
                  this.MOSTDAY.rulevalue = this.MOSTDAY.rulevalue
                    ? this.MOSTDAY.rulevalue
                    : 0;
                  break;
                case "IRAPPLYDAY":
                  this.IRAPPLYDAY = v;
                  this.IRAPPLYDAY.rulevalue = this.IRAPPLYDAY.rulevalue
                    ? this.IRAPPLYDAY.rulevalue
                    : 0;
                  break;
                case "IRAPPLYTIME":
                  this.IRAPPLYTIME = v;
