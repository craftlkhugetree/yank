  ...
  <div class="common-content">
    ...
    >
      ...
      <el-table-column prop="resstatus" label="是否开启" align="center">
        <template slot-scope="scope">
          <span :class="common.actionColor('', '', scope.row.resstatus)">{{
            common.resStateFormatter("", "", scope.row.resstatus)
          }}</span>
        </template>
      </el-table-column>
      <el-table-column label="操作" fixed="right" width="280" align="center">
        <template slot-scope="scope">
          ...
          <div
            v-if="
              (scope.row.usestatus == '1' || scope.row.usestatus == '4') &&
                scope.row.resstatus == '2' &&
                !scope.row.onapply
            "
          ...
          <div
            v-if="scope.row.usestatus == '1' && !scope.row.onapply"
