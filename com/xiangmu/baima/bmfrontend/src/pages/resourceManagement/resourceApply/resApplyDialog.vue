    ...
    >
      ...
      <el-row>
        ...
        <el-col :span="12">
          ...
          <span
            v-if="notRent && form.eduResourceIds && form.eduResourceIds.length > limitNum"
            class="day-tips"
          >
            所选资源数超出规定数量
          </span>
...
export default {
  ...
  components: {
    agreementForm: () => import("./agreementForm")
  },
  data() {
    return {
      checked: false,
      ...
      rules: {
        ...
        classfeeLeaderName: [
          { required: true, message: "请输入课题组经费负责人", trigger: "blur" }
        ],
        applyername: [
        ...
        experimentOverview: [
          { required: true, message: "请输入实验概况", trigger: "blur" }
        ],
        approver: [
