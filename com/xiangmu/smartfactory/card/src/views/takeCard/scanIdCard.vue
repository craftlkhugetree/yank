  ...
  <div class="scan">
    ...
    <div class="div_flex">
      <img
        ...
        alt
        @click="$router.push('/load_unload')"
      />
      <img v-if="!idcard" class="btn line" src="@/assets/img/next-btn-gray.png" alt />
      <img v-else class="btn line" src="@/assets/img/next-btn.png" alt @click="next" />
    </div>
  </div>
</template>
