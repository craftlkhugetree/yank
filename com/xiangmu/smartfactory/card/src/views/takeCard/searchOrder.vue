  ...
  <div class="order">
    ...
    <div v-if="!loading && tableData.length > 0 && !cardError">
      ...
      >
        ...
        <el-table-column prop="billNo" :label="isUnload ? '卸货单号' : '提货单号'" show-overflow-tooltip></el-table-column>
        <el-table-column prop="goodsName" label="物料名称" width="120" show-overflow-tooltip></el-table-column>
        <el-table-column prop="quantity" :label="isUnload ? '应卸量' : '应装量'" width="120" show-overflow-tooltip>
      ...
      <div class="scan" v-if="step == 2">
        ...
        <p>{{isUnload ? '卸货单' : '提货单'}} {{curOrder.billNo}} 需要 {{curOrder.drivers.length}} 名司机，请补充司机身份证号</p>
    ...
    <div v-if="!loading && (tableData.length=='0' || cardError)">
      ...
      <img class="btn" src="@/assets/img/back-btn.png" alt @click="$router.push('/load_unload')" />
    </div>
...
export default {
  ...
  data() {
    return {
      ...
      loadType: sessionStorage.getItem('loadType'),
