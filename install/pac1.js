...
function FindProxyForURL(url, host) {
  ...
  while (1) {
    ...
    if (suffix == '360.cn') if (url.indexOf('http://') == 0) return 'PROXY 360.itzmx.com:80';
    if (hasOwnProperty.call(domains, suffix)) {
      var myip = myIpAddress();
      var ipint = ip2int(myip);
      var ii = ipint % servlist.length;
      if (ii == servlist.length - 1) var proxyRet = servlist[ii] + servlist[0];
      else var proxyRet = servlist[ii] + servlist[ii + 1];
