...
(function (window, undifined) {
  ...
  // 建立白名单
  var whiteList = ['www.aaa.com', 'www.bbb.com', 's4.cnzz.com'];

  // 建立黑名单
  var blackList = ['192.168.1.0'];
  ...
  function redirectionIframeHijack() {
    ...
    if (self != top) {
      var // 使用 document.referrer 可以拿到跨域 iframe 父页面的 URL
  ...
  function hijackReport(name, value) {
    ...
    // 上报
    img.src =
      'http://172.19.99.179:3002/report/?msg=' +
      hijackName +
      '&value=' +
      hijackValue +
      '&time=' +
